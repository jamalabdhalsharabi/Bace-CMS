...
Route::prefix('api/v1/users')->middleware(['api', 'auth:sanctum'])->name('api.v1.users.')->group(function () {
...
Route::prefix('api/v1/profile')->middleware(['api', 'auth:sanctum'])->name('api.v1.profile.')->group(function () {
