...
Route::prefix('api/v1/users')->middleware(['api', 'auth.api'])->name('api.v1.users.')->group(function () {
...
Route::prefix('api/v1/profile')->middleware(['api', 'auth.api'])->name('api.v1.profile.')->group(function () {
